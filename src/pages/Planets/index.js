...
const App = () => {
    const [hex, setHex] = useState("https://swapi.dev/api/planets/1/");

    const alteraCard = () => {
        const randomCard = "https://swapi.dev/api/planets/" + Math.floor(Math.random()*60 + 1) + "/";
        setHex(randomCard);
    };
        ...
        <Container fluid="sm" className='container_center'>
            <div>
                <Row className="justify-content-md-center mb-3">
                    ...
                    <p className="text-center text-uppercase text-white">Population: {post.population}</p>
